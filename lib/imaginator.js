      ...
      if (err) {
        ...
        readInstalled(root, function (err, data) {
          if (err) {
            ...
            console.log('installed', Object.keys(data.dependencies || {}))
            ...
            if (keeperDeps.length === 0) {
              console.log('keeperDeps', 'NONE')
            }
            console.log('keeperDeps', keeperDeps)
            if (toRemove.length === 0) {
              console.log('toRemove', 'NONE')
              cb(null)
            } else {
